 ...
 */
public class FIX50SP1Enumerations {
    ...
    public static class ExecInstValues {
        ...
        public static final char ReleaseFromSuspension                      = 'q';
    ...
    public static class TradeConditionValues {
        ...
        public static final String OutsideSpread                       = "AV";
        public static final String ImpliedTrade                        = "1";
        public static final String MarketplaceEnteredTrade             = "2";
        public static final String MultAssetClassMultilegTrade         = "3";
    ...
    /**
     * Values for FuturesValuationMethod(1197).
     */
    public static class FuturesValuationMethodValues {
        ...
        private FuturesValuationMethodValues() {
        }
